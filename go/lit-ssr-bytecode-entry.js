...
Make sure to test your application with a production build as repeat registrations will throw in production.`);
  ...
  // src/ssr-css-fix.ts
  if (!Object.getOwnPropertyDescriptor(CSSStyleSheetShimWithRealType.prototype, "cssText")) {
    Object.defineProperty(CSSStyleSheetShimWithRealType.prototype, "cssText", {
      get() {
        return Array.from(this.cssRules).map((r6) => r6.cssText).join("");
      },
      configurable: true
    });
  }
  ...
  function btoa(s6) {
    let out = "";
    for (let i7 = 0; i7 < s6.length; i7 += 3) {
      const a3 = s6.charCodeAt(i7);
      const b4 = i7 + 1 < s6.length ? s6.charCodeAt(i7 + 1) : 0;
      const c5 = i7 + 2 < s6.length ? s6.charCodeAt(i7 + 2) : 0;
      out += chars[a3 >> 2 & 63];
      out += chars[(a3 << 4 | b4 >> 4) & 63];
      out += i7 + 1 < s6.length ? chars[(b4 << 2 | c5 >> 6) & 63] : "=";
      out += i7 + 2 < s6.length ? chars[c5 & 63] : "=";
    }
    return out;
  }
  function atob(s6) {
    let out = "";
    const clean = s6.replace(/=+$/, "");
    for (let i7 = 0; i7 < clean.length; i7 += 4) {
      const a3 = chars.indexOf(clean[i7]);
      const b4 = chars.indexOf(clean[i7 + 1]);
      const c5 = chars.indexOf(clean[i7 + 2]);
      const d5 = chars.indexOf(clean[i7 + 3]);
      out += String.fromCharCode((a3 << 2 | b4 >> 4) & 255);
      if (c5 >= 0) out += String.fromCharCode((b4 << 4 | c5 >> 2) & 255);
      if (d5 >= 0) out += String.fromCharCode((c5 << 6 | d5) & 255);
    }
    return out;
  }
  var URLShim = class {
    constructor(url) {
      this.href = url;
      const m4 = url.match(/^(\w+):\/\/([^/:]+)(?::(\d+))?(\/[^?#]*)?(\?[^#]*)?(#.*)?$/) ?? [];
      this.protocol = (m4[1] ?? "http") + ":";
      this.hostname = m4[2] ?? "localhost";
      this.port = m4[3] ?? "";
      this.pathname = m4[4] ?? "/";
      this.search = m4[5] ?? "";
      this.hash = m4[6] ?? "";
    ...
    constructor(init) {
      ...
      if (init) {
        for (const pair of init.split("&")) {
          ...
          const k2 = eq < 0 ? pair : pair.slice(0, eq);
          const v3 = eq < 0 ? "" : pair.slice(eq + 1);
          this._entries.push([decodeURIComponent(k2), decodeURIComponent(v3)]);
        }
      }
    }
    get(key) {
      const found = this._entries.find(([k2]) => k2 === key);
      return found ? found[1] : null;
    }
    has(key) {
      return this._entries.some(([k2]) => k2 === key);
    }
    toString() {
      return this._entries.map(([k2, v3]) => `${encodeURIComponent(k2)}=${encodeURIComponent(v3)}`).join("&");
    }
  };
  Object.assign(globalThis, {
      ...
      from(x2, encoding) {
        if (typeof x2 === "string") {
          if (encoding === "binary") {
            return {
              toString(enc) {
                if (enc === "base64") return btoa(x2);
                return x2;
              }
            };
          }
          return new TextEncoder().encode(x2);
        }
    ...
    Document: class Document2 {
      ...
      createTextNode(data = "") {
        return { nodeType: 3, data, textContent: data };
      }
      createComment(data = "") {
  ...
  var n = "?" + o;
  var r = `<${n}>`;
  var l = void 0 === t.document ? { createTreeWalker: () => ({}) } : document;
...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  var N = (t5, i7) => {
    const s6 = t5.length - 1, e7 = [];
    let n6, l4 = 2 === i7 ? "<svg>" : 3 === i7 ? "<math>" : "", c5 = v;
    for (let i8 = 0; i8 < s6; i8++) {
      const s7 = t5[i8];
      let a3, u3, d5 = -1, f5 = 0;
      for (; f5 < s7.length && (c5.lastIndex = f5, u3 = c5.exec(s7), null !== u3); ) f5 = c5.lastIndex, c5 === v ? "!--" === u3[1] ? c5 = _ : void 0 !== u3[1] ? c5 = m : void 0 !== u3[2] ? (y.test(u3[2]) && (n6 = RegExp("</" + u3[2], "g")), c5 = p) : void 0 !== u3[3] && (c5 = p) : c5 === p ? ">" === u3[0] ? (c5 = n6 ?? v, d5 = -1) : void 0 === u3[1] ? d5 = -2 : (d5 = c5.lastIndex - u3[2].length, a3 = u3[1], c5 = void 0 === u3[3] ? p : '"' === u3[3] ? $ : g) : c5 === $ || c5 === g ? c5 = p : c5 === _ || c5 === m ? c5 = v : (c5 = p, n6 = void 0);
      const x2 = c5 === p && t5[i8 + 1].startsWith("/>") ? " " : "";
      l4 += c5 === v ? s7 + r : d5 >= 0 ? (e7.push(a3), s7.slice(0, d5) + h + s7.slice(d5) + o + x2) : s7 + o + (-2 === d5 ? i8 : x2);
    }
    return [V(t5, l4 + (t5[s6] || "<?>") + (2 === i7 ? "</svg>" : 3 === i7 ? "</math>" : "")), e7];
  };
  var S = class _S {
    constructor({ strings: t5, _$litType$: i7 }, e7) {
      ...
      this.parts = [];
      let l4 = 0, a3 = 0;
      const u3 = t5.length - 1, d5 = this.parts, [f5, v3] = N(t5, i7);
      if (this.el = _S.createElement(f5, e7), P.currentNode = this.el.content, 2 === i7 || 3 === i7) {
        const t6 = this.el.content.firstChild;
        t6.replaceWith(...t6.childNodes);
      }
      for (; null !== (r6 = P.nextNode()) && d5.length < u3; ) {
        if (1 === r6.nodeType) {
          if (r6.hasAttributes()) for (const t6 of r6.getAttributeNames()) if (t6.endsWith(h)) {
            const i8 = v3[a3++], s6 = r6.getAttribute(t6).split(o), e8 = /([.?@])?(.*)/.exec(i8);
            d5.push({ type: 1, index: l4, name: e8[2], strings: s6, ctor: "." === e8[1] ? I : "?" === e8[1] ? L : "@" === e8[1] ? z : H }), r6.removeAttribute(t6);
          } else t6.startsWith(o) && (d5.push({ type: 6, index: l4 }), r6.removeAttribute(t6));
          if (y.test(r6.tagName)) {
            const t6 = r6.textContent.split(o), i8 = t6.length - 1;
            if (i8 > 0) {
              r6.textContent = s ? s.emptyScript : "";
              for (let s6 = 0; s6 < i8; s6++) r6.append(t6[s6], c()), P.nextNode(), d5.push({ type: 2, index: ++l4 });
              r6.append(t6[i8], c());
            }
          }
        } else if (8 === r6.nodeType) if (r6.data === n) d5.push({ type: 2, index: l4 });
        else {
          let t6 = -1;
          for (; -1 !== (t6 = r6.data.indexOf(o, t6 + 1)); ) d5.push({ type: 7, index: l4 }), t6 += o.length - 1;
        }
        l4++;
      }
    }
  ...
  function M(t5, i7, s6 = t5, e7) {
    if (i7 === E) return i7;
    let h3 = void 0 !== e7 ? s6._$Co?.[e7] : s6._$Cl;
    const o8 = a(i7) ? void 0 : i7._$litDirective$;
    return h3?.constructor !== o8 && (h3?._$AO?.(false), void 0 === o8 ? h3 = void 0 : (h3 = new o8(t5), h3._$AT(t5, s6, e7)), void 0 !== e7 ? (s6._$Co ??= [])[e7] = h3 : s6._$Cl = h3), void 0 !== h3 && (i7 = M(t5, h3._$AS(t5, i7.values), h3, e7)), i7;
  }
  var k = class {
    constructor(t5, i7) {
    ...
    u(t5) {
      const { el: { content: i7 }, parts: s6 } = this._$AD, e7 = (t5?.creationScope ?? l).importNode(i7, true);
      P.currentNode = e7;
      let h3 = P.nextNode(), o8 = 0, n6 = 0, r6 = s6[0];
      for (; void 0 !== r6; ) {
        if (o8 === r6.index) {
          let i8;
          2 === r6.type ? i8 = new R(h3, h3.nextSibling, this, t5) : 1 === r6.type ? i8 = new r6.ctor(h3, r6.name, r6.strings, this, t5) : 6 === r6.type && (i8 = new W(h3, this, t5)), this._$AV.push(i8), r6 = s6[++n6];
        }
        o8 !== r6?.index && (h3 = P.nextNode(), o8++);
      }
      return P.currentNode = l, e7;
    }
    p(t5) {
      let i7 = 0;
  ...
  var R = class _R {
    ...
    constructor(t5, i7, s6, e7) {
      this.type = 2, this._$AH = A, this._$AN = void 0, this._$AA = t5, this._$AB = i7, this._$AM = s6, this.options = e7, this._$Cv = e7?.isConnected ?? true;
    }
    get parentNode() {
    ...
    _$AI(t5, i7 = this) {
      t5 = M(this, t5, i7), a(t5) ? t5 === A || null == t5 || "" === t5 ? (this._$AH !== A && this._$AR(), this._$AH = A) : t5 !== this._$AH && t5 !== E && this._(t5) : void 0 !== t5._$litType$ ? this.$(t5) : void 0 !== t5.nodeType ? this.T(t5) : d(t5) ? this.k(t5) : this._(t5);
    }
    O(t5) {
    ...
    $(t5) {
      const { values: i7, _$litType$: s6 } = t5, e7 = "number" == typeof s6 ? this._$AC(t5) : (void 0 === s6.el && (s6.el = S.createElement(V(s6.h, s6.h[0]), this.options)), s6);
      if (this._$AH?._$AD === e7) this._$AH.p(i7);
      else {
        const t6 = new k(e7, this), s7 = t6.u(this.options);
        t6.p(i7), this.T(s7), this._$AH = t6;
      }
    }
    _$AC(t5) {
      let i7 = C.get(t5.strings);
      return void 0 === i7 && C.set(t5.strings, i7 = new S(t5)), i7;
    }
    k(t5) {
      u(this._$AH) || (this._$AH = [], this._$AR());
      const i7 = this._$AH;
      let s6, e7 = 0;
      for (const h3 of t5) e7 === i7.length ? i7.push(s6 = new _R(this.O(c()), this.O(c()), this, this.options)) : s6 = i7[e7], s6._$AI(h3), e7++;
  ...
  var H = class {
    ...
    constructor(t5, i7, s6, e7, h3) {
      this.type = 1, this._$AH = A, this._$AN = void 0, this.element = t5, this.name = i7, this._$AM = e7, this.options = h3, s6.length > 2 || "" !== s6[0] || "" !== s6[1] ? (this._$AH = Array(s6.length - 1).fill(new String()), this.strings = s6) : this._$AH = A;
    }
    _$AI(t5, i7 = this, s6, e7) {
      const h3 = this.strings;
      let o8 = false;
      if (void 0 === h3) t5 = M(this, t5, i7, 0), o8 = !a(t5) || t5 !== this._$AH && t5 !== E, o8 && (this._$AH = t5);
      else {
        const e8 = t5;
        let n6, r6;
        for (t5 = h3[0], n6 = 0; n6 < h3.length - 1; n6++) r6 = M(this, e8[s6 + n6], i7, n6), r6 === E && (r6 = this._$AH[n6]), o8 ||= !a(r6) || r6 !== this._$AH[n6], r6 === A ? t5 = A : t5 !== A && (t5 += (r6 ?? "") + h3[n6 + 1]), this._$AH[n6] = r6;
      }
      o8 && !e7 && this.j(t5);
    }
    j(t5) {
  ...
  var z = class extends H {
    constructor(t5, i7, s6, e7, h3) {
      super(t5, i7, s6, e7, h3), this.type = 5;
    }
    _$AI(t5, i7 = this) {
      if ((t5 = M(this, t5, i7, 0) ?? A) === E) return;
      const s6 = this._$AH, e7 = t5 === A && s6 !== A || t5.capture !== s6.capture || t5.once !== s6.once || t5.passive !== s6.passive, h3 = t5 !== A && (s6 === A || e7);
      e7 && this.element.removeEventListener(this.name, this, s6), h3 && this.element.addEventListener(this.name, this, t5), this._$AH = t5;
    }
    handleEvent(t5) {
  ...
  var Z = { M: h, P: o, A: n, C: 1, L: N, R: k, D: d, V: M, I: R, H, N: L, U: z, B: I, F: W };
  ...
  var B = (t5, i7, s6) => {
    ...
    if (void 0 === h3) {
      ...
      e7._$litPart$ = h3 = new R(i7.insertBefore(c(), t6), t6, void 0, s6 ?? {});
    }
  ...
  var { I: t2 } = Z;
  var n2 = (o8) => null === o8 || "object" != typeof o8 && "function" != typeof o8;
  var e2 = { HTML: 1, SVG: 2, MATHML: 3 };
  var l2 = (o8, t5) => void 0 === t5 ? void 0 !== o8?._$litType$ : o8?._$litType$ === t5;
  var d2 = (o8) => null != o8?._$litType$?.h;
  var f2 = (o8) => o8?._$litDirective$;
  ...
  var ElementRenderer = class {
    ...
    renderAttributes() {
      ...
      if (this.element !== void 0) {
        ...
        for (let i7 = 0, name, value; i7 < attributes2.length && ({ name, value } = attributes2[i7]); i7++) {
  ...
  var n3 = class {
    ...
    get styleSheet() {
      ...
      if (e3 && void 0 === t5) {
        ...
        e7 && (t5 = o2.get(s6)), void 0 === t5 && ((this.o = t5 = new CSSStyleSheet()).replaceSync(this.cssText), e7 && o2.set(s6, t5));
      }
      return t5;
    }
    toString() {
  ...
  var r2 = (t5) => new n3("string" == typeof t5 ? t5 : t5 + "", void 0, s2);
  var S2 = (s6, o8) => {
    if (e3) s6.adoptedStyleSheets = o8.map((t5) => t5 instanceof CSSStyleSheet ? t5 : t5.styleSheet);
    else for (const e7 of o8) {
      const o9 = document.createElement("style"), n6 = t3.litNonce;
      void 0 !== n6 && o9.setAttribute("nonce", n6), o9.textContent = e7.cssText, s6.appendChild(o9);
    }
  };
  var c2 = e3 || void 0 === t3.CSSStyleSheet ? (t5) => t5 : (t5) => t5 instanceof CSSStyleSheet ? ((t6) => {
    let e7 = "";
    for (const s6 of t6.cssRules) e7 += s6.cssText;
    return r2(e7);
  })(t5) : t5;

  // node_modules/@lit/reactive-element/node/reactive-element.js
  var { is: h2, defineProperty: r3, getOwnPropertyDescriptor: o3, getOwnPropertyNames: n4, getOwnPropertySymbols: a2, getPrototypeOf: c3 } = Object;
  var l3 = globalThis;
  l3.customElements ??= customElements2;
  var p2 = l3.trustedTypes;
  var d3 = p2 ? p2.emptyScript : "";
  var u2 = l3.reactiveElementPolyfillSupport;
  var f3 = (t5, s6) => t5;
  var b2 = { toAttribute(t5, s6) {
    switch (s6) {
      case Boolean:
        t5 = t5 ? d3 : null;
        break;
  ...
  var m2 = (t5, s6) => !h2(t5, s6);
  var y2 = { attribute: true, type: String, converter: b2, reflect: false, useDefault: false, hasChanged: m2 };
  ...
  var g2 = class extends (globalThis.HTMLElement ?? HTMLElementShimWithRealType) {
    ...
    static createProperty(t5, s6 = y2) {
      if (s6.state && (s6.attribute = false), this._$Ei(), this.prototype.hasOwnProperty(t5) && ((s6 = Object.create(s6)).wrapped = true), this.elementProperties.set(t5, s6), !s6.noAccessor) {
        const i7 = /* @__PURE__ */ Symbol(), e7 = this.getPropertyDescriptor(t5, i7, s6);
        void 0 !== e7 && r3(this.prototype, t5, e7);
      }
    }
    static getPropertyDescriptor(t5, s6, i7) {
      const { get: e7, set: h3 } = o3(this.prototype, t5) ?? { get() {
        return this[s6];
      }, set(t6) {
        this[s6] = t6;
      } };
      return { get: e7, set(s7) {
        ...
        h3?.call(this, s7), this.requestUpdate(t5, r6, i7);
    ...
    static _$Ei() {
      if (this.hasOwnProperty(f3("elementProperties"))) return;
      const t5 = c3(this);
      t5.finalize(), void 0 !== t5.l && (this.l = [...t5.l]), this.elementProperties = new Map(t5.elementProperties);
    }
    static finalize() {
      if (this.hasOwnProperty(f3("finalized"))) return;
      if (this.finalized = true, this._$Ei(), this.hasOwnProperty(f3("properties"))) {
        const t6 = this.properties, s6 = [...n4(t6), ...a2(t6)];
    ...
    static finalizeStyles(t5) {
      ...
      if (Array.isArray(t5)) {
        ...
        for (const t6 of e7) s6.unshift(c2(t6));
      } else void 0 !== t5 && s6.push(c2(t5));
      return s6;
    }
    static _$Eu(t5, s6) {
    ...
    _$ET(t5, s6) {
      ...
      if (void 0 !== e7 && true === i7.reflect) {
        const h3 = (void 0 !== i7.converter?.toAttribute ? i7.converter : b2).toAttribute(s6, i7.type);
    ...
    _$AK(t5, s6) {
      ...
      if (void 0 !== e7 && this._$Em !== e7) {
        const t6 = i7.getPropertyOptions(e7), h3 = "function" == typeof t6.converter ? { fromAttribute: t6.converter } : void 0 !== t6.converter?.fromAttribute ? t6.converter : b2;
        this._$Em = e7;
        const r6 = h3.fromAttribute(s6, t6.type);
        this[e7] = r6 ?? this._$Ej?.get(e7) ?? r6, this._$Em = null;
      }
    }
    requestUpdate(t5, s6, i7, e7 = false, h3) {
      if (void 0 !== t5) {
        const r6 = this.constructor;
        if (false === e7 && (h3 = this[t5]), i7 ??= r6.getPropertyOptions(t5), !((i7.hasChanged ?? m2)(h3, s6) || i7.useDefault && i7.reflect && h3 === this._$Ej?.get(t5) && !this.hasAttribute(r6._$Eu(t5, i7)))) return;
        this.C(t5, s6, i7);
      }
      false === this.isUpdatePending && (this._$ES = this._$EP());
    }
    C(t5, s6, { useDefault: i7, reflect: e7, wrapped: h3 }, r6) {
      i7 && !(this._$Ej ??= /* @__PURE__ */ new Map()).has(t5) && (this._$Ej.set(t5, r6 ?? s6 ?? this[t5]), true !== h3 || void 0 !== r6) || (this._$AL.has(t5) || (this.hasUpdated || i7 || (s6 = void 0), this._$AL.set(t5, s6)), true === e7 && this._$Em !== t5 && (this._$Eq ??= /* @__PURE__ */ new Set()).add(t5));
    }
    async _$EP() {
    ...
    performUpdate() {
      ...
      if (!this.hasUpdated) {
        ...
        if (t6.size > 0) for (const [s7, i7] of t6) {
          const { wrapped: t7 } = i7, e7 = this[s7];
          true !== t7 || this._$AL.has(s7) || void 0 === e7 || this.C(s7, void 0, i7, e7);
        }
      }
      let t5 = false;
      const s6 = this._$AL;
  ...
  g2.elementStyles = [], g2.shadowRootOptions = { mode: "open" }, g2[f3("elementProperties")] = /* @__PURE__ */ new Map(), g2[f3("finalized")] = /* @__PURE__ */ new Map(), u2?.({ ReactiveElement: g2 }), (l3.reactiveElementVersions ??= []).push("2.1.2");
  ...
  o4?.({ LitElement: i3 });
  var n5 = { _$AK: (t5, e7, r6) => {
    t5._$AK(e7, r6);
  }, _$AL: (t5) => t5._$AL };
  (s3.litElementVersions ??= []).push("4.2.2");

  // node_modules/lit-element/private-ssr-support.js
  var e4 = { attributeToProperty: n5._$AK, changedProperties: n5._$AL };
  ...
  var r4 = null;
  var i5 = { boundAttributeSuffix: Z.M, marker: Z.P, markerMatch: Z.A, HTML_RESULT: Z.C, getTemplateHtml: Z.L, overrideDirectiveResolve: (e7, t5) => class extends e7 {
    _$AS(e8, r6) {
      return t5(this, r6);
    }
  }, patchDirectiveResolve: (e7, t5) => {
    if (e7.prototype._$AS.name !== t5.name) {
      r4 ??= e7.prototype._$AS.name;
      for (let i7 = e7.prototype; i7 !== Object.prototype; i7 = Object.getPrototypeOf(i7)) if (i7.hasOwnProperty(r4)) return void (i7[r4] = t5);
  ...
  }, setDirectiveClass(e7, t5) {
    e7._$litDirective$ = t5;
  }, getAttributePartCommittedValue: (e7, r6, i7) => {
    let o8 = E;
    return e7.j = (e8) => o8 = e8, e7._$AI(r6, e7, i7), o8;
  }, connectedDisconnectable: (e7) => ({ ...e7, _$AU: true }), resolveDirective: Z.V, AttributePart: Z.H, PropertyPart: Z.B, BooleanAttributePart: Z.N, EventPart: Z.U, ElementPart: Z.F, TemplateInstance: Z.R, isIterable: Z.D, ChildPart: Z.I };
  ...
  var Buffer2 = {
    from(x2, encoding) {
      if (typeof x2 === "string") {
        if (encoding === "binary") {
          return {
            toString(enc) {
              if (enc === "base64") return globalThis.btoa(x2);
              return x2;
            }
          };
        }
    ...
    isBuffer: () => false,
    alloc: (n6) => new Uint8Array(n6)
  };

  // node_modules/@lit-labs/ssr-client/node/lib/hydrate-lit-html.js
  var { TemplateInstance: s4, isIterable: d4, resolveDirective: c4, ChildPart: p3, ElementPart: f4 } = i5;
  var v2 = /* @__PURE__ */ new WeakMap();
  var b3 = (t5) => {
    let r6 = v2.get(t5.strings);
    if (void 0 !== r6) return r6;
    const n6 = new Uint32Array(2).fill(5381);
    for (const e7 of t5.strings) for (let t6 = 0; t6 < e7.length; t6++) n6[t6 % 2] = 33 * n6[t6 % 2] ^ e7.charCodeAt(t6);
    const o8 = String.fromCharCode(...new Uint8Array(n6.buffer));
    return r6 = Buffer2.from(o8, "binary").toString("base64"), v2.set(t5.strings, r6), r6;
  };
  ...
  var Preprocessor = class {
    ...
    startsWith(pattern, caseSensitive) {
      ...
      for (let i7 = 0; i7 < pattern.length; i7++) {
        const cp = this.html.charCodeAt(this.pos + i7) | 32;
        if (cp !== pattern.charCodeAt(i7)) {
          return false;
        }
      }
      return true;
  ...
  var Tokenizer = class {
    ...
    _err(code, cpOffset = 0) {
      var _a4, _b2;
      (_b2 = (_a4 = this.handler).onParseError) === null || _b2 === void 0 ? void 0 : _b2.call(_a4, this.preprocessor.getError(code, cpOffset));
    }
    ...
    _createCharacterToken(type, chars2) {
    ...
    _leaveAttrName() {
      ...
      if (getTokenAttr(token, this.currentAttr.name) === null) {
        ...
        if (token.location && this.currentLocation) {
          const attrLocations = (_a4 = (_b2 = token.location).attrs) !== null && _a4 !== void 0 ? _a4 : _b2.attrs = /* @__PURE__ */ Object.create(null);
    ...
    _stateScriptDataDoubleEscapeStart(cp) {
      if (this.preprocessor.startsWith(SEQUENCES.SCRIPT, false) && isScriptDataDoubleEscapeSequenceEnd(this.preprocessor.peek(SEQUENCES.SCRIPT.length))) {
        this._emitCodePoint(cp);
        for (let i7 = 0; i7 < SEQUENCES.SCRIPT.length; i7++) {
  ...
  var OpenElementStack = class {
    ...
    _indexOfTagNames(tagNames, namespace) {
      for (let i7 = this.stackTop; i7 >= 0; i7--) {
        if (tagNames.has(this.tagIDs[i7]) && this.treeAdapter.getNamespaceURI(this.items[i7]) === namespace) {
          return i7;
        }
      }
      return -1;
    ...
    hasInDynamicScope(tagName, htmlScope) {
      for (let i7 = this.stackTop; i7 >= 0; i7--) {
        const tn = this.tagIDs[i7];
        switch (this.treeAdapter.getNamespaceURI(this.items[i7])) {
          case NS.HTML: {
            if (tn === tagName)
              return true;
            if (htmlScope.has(tn))
    ...
    hasInTableScope(tagName) {
      for (let i7 = this.stackTop; i7 >= 0; i7--) {
        if (this.treeAdapter.getNamespaceURI(this.items[i7]) !== NS.HTML) {
          continue;
        }
        switch (this.tagIDs[i7]) {
          case tagName: {
            return true;
          }
          case TAG_ID.TABLE:
  ...
  var FormattingElementList = class {
    ...
    _getNoahArkConditionCandidates(newElement, neAttrs) {
      ...
      for (let i7 = 0; i7 < this.entries.length; i7++) {
    ...
    _ensureNoahArkCondition(newElement) {
      ...
      for (let i7 = 0; i7 < candidates.length; i7++) {
        const candidate = candidates[i7];
  ...
  function adjustTokenSVGAttrs(token) {
    for (let i7 = 0; i7 < token.attrs.length; i7++) {
      const adjustedAttrName = SVG_ATTRS_ADJUSTMENT_MAP.get(token.attrs[i7].name);
  ...
  function adjustTokenXMLAttrs(token) {
    for (let i7 = 0; i7 < token.attrs.length; i7++) {
      const adjustedAttrEntry = XML_ATTRS_ADJUSTMENT_MAP.get(token.attrs[i7].name);
  ...
  var Parser = class {
    ...
    onItemPush(node, tid, isTop) {
      var _a4, _b2;
      (_b2 = (_a4 = this.treeAdapter).onItemPush) === null || _b2 === void 0 ? void 0 : _b2.call(_a4, node);
    ...
    onItemPop(node, isTop) {
      ...
      (_b2 = (_a4 = this.treeAdapter).onItemPop) === null || _b2 === void 0 ? void 0 : _b2.call(_a4, node, this.openElements.current);
      if (isTop) {
        let current;
        let currentTagId;
    ...
    _reconstructActiveFormattingElements() {
      ...
      if (listLength) {
        ...
        for (let i7 = unopenIdx; i7 >= 0; i7--) {
          const entry = this.activeFormattingElements.entries[i7];
    ...
    _resetInsertionMode() {
      for (let i7 = this.openElements.stackTop; i7 >= 0; i7--) {
        switch (i7 === 0 && this.fragmentContext ? this.fragmentContextID : this.openElements.tagIDs[i7]) {
          case TAG_ID.TR: {
            this.insertionMode = InsertionMode.IN_ROW;
            return;
          }
    ...
    _resetInsertionModeForSelect(selectIdx) {
      if (selectIdx > 0) {
        for (let i7 = selectIdx - 1; i7 > 0; i7--) {
          const tn = this.openElements.tagIDs[i7];
    ...
    _findFosterParentingLocation() {
      for (let i7 = this.openElements.stackTop; i7 >= 0; i7--) {
        ...
        switch (this.openElements.tagIDs[i7]) {
          case TAG_ID.TEMPLATE: {
          ...
          case TAG_ID.TABLE: {
            ...
            return { parent: this.openElements.items[i7 - 1], beforeElement: null };
          }
          default:
        }
      }
  ...
  function aaObtainFurthestBlock(p4, formattingElementEntry) {
    ...
    for (; idx >= 0; idx--) {
      const element = p4.openElements.items[idx];
      if (element === formattingElementEntry.element) {
        break;
      }
      if (p4._isSpecialElement(element, p4.openElements.tagIDs[idx])) {
  ...
  function stopParsing(p4, token) {
    ...
    if (token.location) {
      ...
      for (let i7 = p4.openElements.stackTop; i7 >= target; i7--) {
        p4._setEndLocation(p4.openElements.items[i7], token);
      }
  ...
  function listItemStartTagInBody(p4, token) {
    p4.framesetOk = false;
    const tn = token.tagID;
    for (let i7 = p4.openElements.stackTop; i7 >= 0; i7--) {
      const elementId = p4.openElements.tagIDs[i7];
      ...
      if (elementId !== TAG_ID.ADDRESS && elementId !== TAG_ID.DIV && elementId !== TAG_ID.P && p4._isSpecialElement(p4.openElements.items[i7], elementId)) {
        break;
      }
    }
    if (p4.openElements.hasInButtonScope(TAG_ID.P)) {
  ...
  function genericEndTagInBody(p4, token) {
    ...
    for (let i7 = p4.openElements.stackTop; i7 > 0; i7--) {
      const element = p4.openElements.items[i7];
      const elementId = p4.openElements.tagIDs[i7];
      if (tid === elementId && (tid !== TAG_ID.UNKNOWN || p4.treeAdapter.getTagName(element) === tn)) {
        p4.openElements.generateImpliedEndTagsWithExclusion(tid);
        if (p4.openElements.stackTop >= i7)
          p4.openElements.shortenToLength(i7);
        break;
      }
      if (p4._isSpecialElement(element, elementId)) {
        break;
      }
    }
  }
  ...
  function endTagInText(p4, token) {
    ...
    if (token.tagID === TAG_ID.SCRIPT) {
      (_a4 = p4.scriptHandler) === null || _a4 === void 0 ? void 0 : _a4.call(p4, p4.openElements.current);
    }
    p4.openElements.pop();
  ...
  function tokenInTableText(p4, token) {
    ...
    if (p4.hasNonWhitespacePendingCharacterToken) {
      for (; i7 < p4.pendingCharacterTokens.length; i7++) {
        tokenInTable(p4, p4.pendingCharacterTokens[i7]);
      }
    } else {
      for (; i7 < p4.pendingCharacterTokens.length; i7++) {
        p4._insertCharacters(p4.pendingCharacterTokens[i7]);
      }
    }
    p4.insertionMode = p4.originalInsertionMode;
    p4._processToken(token);
  ...
  function endTagAfterBody(p4, token) {
    ...
    if (token.tagID === TAG_ID.HTML) {
      ...
      if (p4.options.sourceCodeLocationInfo && p4.openElements.tagIDs[0] === TAG_ID.HTML) {
        ...
        const bodyElement = p4.openElements.items[1];
        if (bodyElement && !((_a4 = p4.treeAdapter.getNodeSourceCodeLocation(bodyElement)) === null || _a4 === void 0 ? void 0 : _a4.endTag)) {
          p4._setEndLocation(bodyElement, token);
        }
      }
    } else {
  ...
  function endTagInForeignContent(p4, token) {
    ...
    for (let i7 = p4.openElements.stackTop; i7 > 0; i7--) {
      ...
      const tagName = p4.treeAdapter.getTagName(element);
  ...
  var getCodePoint = (
    ...
    String.prototype.codePointAt == null ? (c5, index) => (c5.charCodeAt(index) & 64512) === 55296 ? (c5.charCodeAt(index) - 55296) * 1024 + c5.charCodeAt(index + 1) - 56320 + 65536 : c5.charCodeAt(index) : (
  ...
  var i6 = class extends i4 {
    render() {
    }
    update(e7) {
      const t5 = e7.parentNode;
      if ("function" == typeof t5.renderLight) return t5.renderLight();
    }
  };
  i6.t = true;
  var o5 = e5(i6);
  ...
  var { getTemplateHtml, marker, markerMatch, boundAttributeSuffix, patchDirectiveResolve, getAttributePartCommittedValue, resolveDirective, AttributePart, PropertyPart, BooleanAttributePart, EventPart, connectedDisconnectable, isIterable } = i5;
  function ssrResolve(_part, values) {
    return patchIfDirective(this.render(...values));
  }
  var patchIfDirective = (value) => {
    const directiveCtor = f2(value);
  ...
  var elementSlotMap = /* @__PURE__ */ new WeakMap();
  var HTMLSlotElement = class extends HTMLElementShimWithRealType {
    get localName() {
      return "slot";
    }
  };
  ...
  function renderValue(value, renderInfo, hydratable = true) {
    ...
    if (s5(value)) {
      ...
      value = resolveDirective(connectedDisconnectable({ type: t4.CHILD }), value);
    }
    const result = [];
...
And the inner template was:
        ...
        case "attribute-part": {
          renderResult.push(() => {
            ...
            if (committedValue !== E) {
              ...
              if (part.type === t4.PROPERTY) {
                attributeResult = renderPropertyPart(instance, op, committedValue);
              } else if (part.type === t4.BOOLEAN_ATTRIBUTE) {
        ...
        case "custom-element-open": {
          renderResult.push(() => {
            ...
            if (instance.element) {
              ...
              instance.element.__eventTargetParent = elementSlotMap.get(eventTarget)?.get(slotName) ?? eventTarget;
              instance.element.__host = renderInfo.customElementHostStack.at(-1)?.element;
          ...
          renderResult.push(() => {
            ...
            if (host === void 0) {
              ...
              if (!slots.has(op.name)) {
                ...
                const eventTarget = renderInfo.eventTargetStack.at(-1);
                const slotName = renderInfo.slotStack.at(-1);
                element.__eventTargetParent = elementSlotMap.get(eventTarget)?.get(slotName) ?? eventTarget;
  ...
  i3.prototype["createRenderRoot"] = function() {
      ...
      while (true) {
        ...
        return {
          ...
          value: value.then((r6) => {
            ...
            this._iterators.push(r6[Symbol.iterator]());
            return this;
          })
        };
      }
  ...
  // src/harness/render.ts
  function processHTML(input) {
    const template = T`${o7(input)}`;
    const chunks = [];
  ...
  function readUntilNul() {
    ...
    for (; ; ) {
      const n6 = Javy.IO.readSync(0, buf);
      if (n6 === 0) return chunks.length > 0 ? new TextDecoder().decode(new Uint8Array(chunks)) : null;
  ...
  // src/bytecode-entry.ts
  globalThis.__LITSSR_USER_SOURCE__ = true;
  var initLine = readLine();

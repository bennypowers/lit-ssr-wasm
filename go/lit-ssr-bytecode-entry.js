...
Make sure to test your application with a production build as repeat registrations will throw in production.`);
  ...
  function btoa(s7) {
    let out = "";
    for (let i7 = 0; i7 < s7.length; i7 += 3) {
      const a4 = s7.charCodeAt(i7);
      const b4 = i7 + 1 < s7.length ? s7.charCodeAt(i7 + 1) : 0;
      const c6 = i7 + 2 < s7.length ? s7.charCodeAt(i7 + 2) : 0;
      out += chars[a4 >> 2 & 63];
      out += chars[(a4 << 4 | b4 >> 4) & 63];
      out += i7 + 1 < s7.length ? chars[(b4 << 2 | c6 >> 6) & 63] : "=";
      out += i7 + 2 < s7.length ? chars[c6 & 63] : "=";
    }
    return out;
  }
  function atob(s7) {
    let out = "";
    const clean = s7.replace(/=+$/, "");
    for (let i7 = 0; i7 < clean.length; i7 += 4) {
      const a4 = chars.indexOf(clean[i7]);
      const b4 = chars.indexOf(clean[i7 + 1]);
      const c6 = chars.indexOf(clean[i7 + 2]);
      const d5 = chars.indexOf(clean[i7 + 3]);
      out += String.fromCharCode((a4 << 2 | b4 >> 4) & 255);
      if (c6 >= 0) out += String.fromCharCode((b4 << 4 | c6 >> 2) & 255);
      if (d5 >= 0) out += String.fromCharCode((c6 << 6 | d5) & 255);
    }
    return out;
  }
  var URLShim = class {
...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  var N = (t5, i7) => {
    ...
    let n7, l5 = 2 === i7 ? "<svg>" : 3 === i7 ? "<math>" : "", c6 = v;
    for (let i8 = 0; i8 < s7; i8++) {
      const s8 = t5[i8];
      let a4, u4, d5 = -1, f5 = 0;
      for (; f5 < s8.length && (c6.lastIndex = f5, u4 = c6.exec(s8), null !== u4); ) f5 = c6.lastIndex, c6 === v ? "!--" === u4[1] ? c6 = _ : void 0 !== u4[1] ? c6 = m : void 0 !== u4[2] ? (y.test(u4[2]) && (n7 = RegExp("</" + u4[2], "g")), c6 = p) : void 0 !== u4[3] && (c6 = p) : c6 === p ? ">" === u4[0] ? (c6 = n7 ?? v, d5 = -1) : void 0 === u4[1] ? d5 = -2 : (d5 = c6.lastIndex - u4[2].length, a4 = u4[1], c6 = void 0 === u4[3] ? p : '"' === u4[3] ? $ : g) : c6 === $ || c6 === g ? c6 = p : c6 === _ || c6 === m ? c6 = v : (c6 = p, n7 = void 0);
      const x2 = c6 === p && t5[i8 + 1].startsWith("/>") ? " " : "";
      l5 += c6 === v ? s8 + r : d5 >= 0 ? (e6.push(a4), s8.slice(0, d5) + h + s8.slice(d5) + o + x2) : s8 + o + (-2 === d5 ? i8 : x2);
    }
    return [V(t5, l5 + (t5[s7] || "<?>") + (2 === i7 ? "</svg>" : 3 === i7 ? "</math>" : "")), e6];
  };
  var S = class _S {
    constructor({ strings: t5, _$litType$: i7 }, e6) {
      ...
      this.parts = [];
      let l5 = 0, a4 = 0;
      const u4 = t5.length - 1, d5 = this.parts, [f5, v3] = N(t5, i7);
      if (this.el = _S.createElement(f5, e6), P.currentNode = this.el.content, 2 === i7 || 3 === i7) {
        const t6 = this.el.content.firstChild;
        t6.replaceWith(...t6.childNodes);
      }
      for (; null !== (r6 = P.nextNode()) && d5.length < u4; ) {
        if (1 === r6.nodeType) {
          if (r6.hasAttributes()) for (const t6 of r6.getAttributeNames()) if (t6.endsWith(h)) {
            const i8 = v3[a4++], s7 = r6.getAttribute(t6).split(o), e7 = /([.?@])?(.*)/.exec(i8);
            d5.push({ type: 1, index: l5, name: e7[2], strings: s7, ctor: "." === e7[1] ? I : "?" === e7[1] ? L : "@" === e7[1] ? z : H }), r6.removeAttribute(t6);
          } else t6.startsWith(o) && (d5.push({ type: 6, index: l5 }), r6.removeAttribute(t6));
          if (y.test(r6.tagName)) {
            const t6 = r6.textContent.split(o), i8 = t6.length - 1;
            if (i8 > 0) {
              r6.textContent = s ? s.emptyScript : "";
              for (let s7 = 0; s7 < i8; s7++) r6.append(t6[s7], c()), P.nextNode(), d5.push({ type: 2, index: ++l5 });
              r6.append(t6[i8], c());
            }
          }
        } else if (8 === r6.nodeType) if (r6.data === n) d5.push({ type: 2, index: l5 });
        else {
          let t6 = -1;
          for (; -1 !== (t6 = r6.data.indexOf(o, t6 + 1)); ) d5.push({ type: 7, index: l5 }), t6 += o.length - 1;
        }
        l5++;
      }
    }
  ...
  function M(t5, i7, s7 = t5, e6) {
    if (i7 === E) return i7;
    let h3 = void 0 !== e6 ? s7._$Co?.[e6] : s7._$Cl;
    const o8 = a(i7) ? void 0 : i7._$litDirective$;
    return h3?.constructor !== o8 && (h3?._$AO?.(false), void 0 === o8 ? h3 = void 0 : (h3 = new o8(t5), h3._$AT(t5, s7, e6)), void 0 !== e6 ? (s7._$Co ??= [])[e6] = h3 : s7._$Cl = h3), void 0 !== h3 && (i7 = M(t5, h3._$AS(t5, i7.values), h3, e6)), i7;
  }
  var k = class {
    constructor(t5, i7) {
    ...
    u(t5) {
      const { el: { content: i7 }, parts: s7 } = this._$AD, e6 = (t5?.creationScope ?? l).importNode(i7, true);
      P.currentNode = e6;
      let h3 = P.nextNode(), o8 = 0, n7 = 0, r6 = s7[0];
      for (; void 0 !== r6; ) {
        if (o8 === r6.index) {
          let i8;
          2 === r6.type ? i8 = new R(h3, h3.nextSibling, this, t5) : 1 === r6.type ? i8 = new r6.ctor(h3, r6.name, r6.strings, this, t5) : 6 === r6.type && (i8 = new W(h3, this, t5)), this._$AV.push(i8), r6 = s7[++n7];
        }
        o8 !== r6?.index && (h3 = P.nextNode(), o8++);
      }
      return P.currentNode = l, e6;
    }
    p(t5) {
      let i7 = 0;
  ...
  var R = class _R {
    ...
    $(t5) {
      const { values: i7, _$litType$: s7 } = t5, e6 = "number" == typeof s7 ? this._$AC(t5) : (void 0 === s7.el && (s7.el = S.createElement(V(s7.h, s7.h[0]), this.options)), s7);
      if (this._$AH?._$AD === e6) this._$AH.p(i7);
      else {
        const t6 = new k(e6, this), s8 = t6.u(this.options);
    ...
    k(t5) {
      ...
      const i7 = this._$AH;
      let s7, e6 = 0;
      for (const h3 of t5) e6 === i7.length ? i7.push(s7 = new _R(this.O(c()), this.O(c()), this, this.options)) : s7 = i7[e6], s7._$AI(h3), e6++;
  ...
  var H = class {
    ...
    constructor(t5, i7, s7, e6, h3) {
      this.type = 1, this._$AH = A, this._$AN = void 0, this.element = t5, this.name = i7, this._$AM = e6, this.options = h3, s7.length > 2 || "" !== s7[0] || "" !== s7[1] ? (this._$AH = Array(s7.length - 1).fill(new String()), this.strings = s7) : this._$AH = A;
    }
    _$AI(t5, i7 = this, s7, e6) {
      ...
      if (void 0 === h3) t5 = M(this, t5, i7, 0), o8 = !a(t5) || t5 !== this._$AH && t5 !== E, o8 && (this._$AH = t5);
        ...
        const e7 = t5;
        let n7, r6;
        for (t5 = h3[0], n7 = 0; n7 < h3.length - 1; n7++) r6 = M(this, e7[s7 + n7], i7, n7), r6 === E && (r6 = this._$AH[n7]), o8 ||= !a(r6) || r6 !== this._$AH[n7], r6 === A ? t5 = A : t5 !== A && (t5 += (r6 ?? "") + h3[n7 + 1]), this._$AH[n7] = r6;
      }
      o8 && !e6 && this.j(t5);
    }
    j(t5) {
  ...
  var z = class extends H {
    constructor(t5, i7, s7, e6, h3) {
      super(t5, i7, s7, e6, h3), this.type = 5;
    }
    _$AI(t5, i7 = this) {
      if ((t5 = M(this, t5, i7, 0) ?? A) === E) return;
      const s7 = this._$AH, e6 = t5 === A && s7 !== A || t5.capture !== s7.capture || t5.once !== s7.once || t5.passive !== s7.passive, h3 = t5 !== A && (s7 === A || e6);
      e6 && this.element.removeEventListener(this.name, this, s7), h3 && this.element.addEventListener(this.name, this, t5), this._$AH = t5;
    }
    handleEvent(t5) {
  ...
  var B = (t5, i7, s7) => {
    ...
    if (void 0 === h3) {
      ...
      e6._$litPart$ = h3 = new R(i7.insertBefore(c(), t6), t6, void 0, s7 ?? {});
    }
  ...
  var n3 = class {
    ...
    get styleSheet() {
      ...
      if (e3 && void 0 === t5) {
        ...
        e6 && (t5 = o2.get(s7)), void 0 === t5 && ((this.o = t5 = new CSSStyleSheet()).replaceSync(this.cssText), e6 && o2.set(s7, t5));
      }
      return t5;
    }
    toString() {
  ...
  var S2 = (s7, o8) => {
    if (e3) s7.adoptedStyleSheets = o8.map((t5) => t5 instanceof CSSStyleSheet ? t5 : t5.styleSheet);
  ...
  var g2 = class extends (globalThis.HTMLElement ?? HTMLElementShimWithRealType) {
    ...
    static createProperty(t5, s7 = y2) {
      if (s7.state && (s7.attribute = false), this._$Ei(), this.prototype.hasOwnProperty(t5) && ((s7 = Object.create(s7)).wrapped = true), this.elementProperties.set(t5, s7), !s7.noAccessor) {
        const i7 = /* @__PURE__ */ Symbol(), e6 = this.getPropertyDescriptor(t5, i7, s7);
        void 0 !== e6 && r3(this.prototype, t5, e6);
      }
    }
    static getPropertyDescriptor(t5, s7, i7) {
      const { get: e6, set: h3 } = o3(this.prototype, t5) ?? { get() {
        return this[s7];
      }, set(t6) {
        this[s7] = t6;
      } };
      return { get: e6, set(s8) {
        ...
        h3?.call(this, s8), this.requestUpdate(t5, r6, i7);
    ...
    static finalize() {
      ...
      if (this.finalized = true, this._$Ei(), this.hasOwnProperty(f3("properties"))) {
        const t6 = this.properties, s7 = [...n4(t6), ...a2(t6)];
    ...
    static finalizeStyles(t5) {
      ...
      if (Array.isArray(t5)) {
        ...
        for (const t6 of e6) s7.unshift(c2(t6));
    ...
    _$ET(t5, s7) {
      ...
      if (void 0 !== e6 && true === i7.reflect) {
        const h3 = (void 0 !== i7.converter?.toAttribute ? i7.converter : b2).toAttribute(s7, i7.type);
    ...
    _$AK(t5, s7) {
      ...
      if (void 0 !== e6 && this._$Em !== e6) {
        const t6 = i7.getPropertyOptions(e6), h3 = "function" == typeof t6.converter ? { fromAttribute: t6.converter } : void 0 !== t6.converter?.fromAttribute ? t6.converter : b2;
        this._$Em = e6;
        const r6 = h3.fromAttribute(s7, t6.type);
        this[e6] = r6 ?? this._$Ej?.get(e6) ?? r6, this._$Em = null;
      }
    }
    requestUpdate(t5, s7, i7, e6 = false, h3) {
      if (void 0 !== t5) {
        const r6 = this.constructor;
        if (false === e6 && (h3 = this[t5]), i7 ??= r6.getPropertyOptions(t5), !((i7.hasChanged ?? m2)(h3, s7) || i7.useDefault && i7.reflect && h3 === this._$Ej?.get(t5) && !this.hasAttribute(r6._$Eu(t5, i7)))) return;
        this.C(t5, s7, i7);
      }
      false === this.isUpdatePending && (this._$ES = this._$EP());
    }
    C(t5, s7, { useDefault: i7, reflect: e6, wrapped: h3 }, r6) {
      i7 && !(this._$Ej ??= /* @__PURE__ */ new Map()).has(t5) && (this._$Ej.set(t5, r6 ?? s7 ?? this[t5]), true !== h3 || void 0 !== r6) || (this._$AL.has(t5) || (this.hasUpdated || i7 || (s7 = void 0), this._$AL.set(t5, s7)), true === e6 && this._$Em !== t5 && (this._$Eq ??= /* @__PURE__ */ new Set()).add(t5));
    }
    async _$EP() {
  ...
  var r4 = null;
  var i5 = { boundAttributeSuffix: Z.M, marker: Z.P, markerMatch: Z.A, HTML_RESULT: Z.C, getTemplateHtml: Z.L, overrideDirectiveResolve: (e6, t5) => class extends e6 {
    _$AS(e7, r6) {
      return t5(this, r6);
    }
  }, patchDirectiveResolve: (e6, t5) => {
    if (e6.prototype._$AS.name !== t5.name) {
      r4 ??= e6.prototype._$AS.name;
      for (let i7 = e6.prototype; i7 !== Object.prototype; i7 = Object.getPrototypeOf(i7)) if (i7.hasOwnProperty(r4)) return void (i7[r4] = t5);
  ...
  }, getAttributePartCommittedValue: (e6, r6, i7) => {
    let o8 = E;
    return e6.j = (e7) => o8 = e7, e6._$AI(r6, e6, i7), o8;
  ...
  var b3 = (t5) => {
    ...
    const n7 = new Uint32Array(2).fill(5381);
    for (const e6 of t5.strings) for (let t6 = 0; t6 < e6.length; t6++) n7[t6 % 2] = 33 * n7[t6 % 2] ^ e6.charCodeAt(t6);
    const o8 = String.fromCharCode(...new Uint8Array(n7.buffer));
        ...
        if (isCommentNode(node)) {
          ...
          if (node.parentNode && isElementNode(node.parentNode) && node.parentNode.isDefinedCustomElement) {
            ops.push({
              ...
              name: node.attrs.find((a4) => a4.name === "slot")?.value
            });
          }
          if (tagName.indexOf("-") !== -1) {
            ...
            ops.push({
              ...
              // an unnamed slot.
              name: node.attrs.find((a4) => a4.name === "name")?.value
            });
          }
...
And the inner template was:
  ...
  var n6 = (t5) => (r6, ...e6) => {
    ...
    let c6, $4 = 0, f5 = false;
    for (; $4 < a4; ) {
      for (c6 = r6[$4]; $4 < a4 && void 0 !== (i7 = e6[$4], s7 = o7(i7)); ) c6 += s7 + r6[++$4], f5 = true;
      $4 !== a4 && u4.push(i7), n7.push(c6), $4++;
    }
    if ($4 === a4 && n7.push(r6[a4]), f5) {
      const t6 = n7.join("$$lit$$");
      void 0 === (r6 = l4.get(t6)) && (n7.raw = n7, l4.set(t6, r6 = n7)), e6 = u4;
    }
    return t5(r6, ...e6);
  };
  var u3 = n6(T);
  ...
  function renderElementToString(tag, attrs, slotContent) {
    const tagLiteral = s6(tag);
    const attrStr = Object.entries(attrs).map(([k2, v3]) => v3 === "" ? k2 : `${k2}="${v3}"`).join(" ");
    const attrLiteral = attrStr ? s6(` ${attrStr}`) : s6("");
    const contentLiteral = s6(slotContent);
    const template = u3`<${tagLiteral}${attrLiteral}>${contentLiteral}</${tagLiteral}>`;
    const chunks = [];
  ...
  function findCloseTag(input, tagName, searchFrom) {
  ...
  function parseAttrs(attrString) {
    ...
    let m4;
    while ((m4 = re.exec(attrString)) !== null) {
      attrs[m4[1]] = m4[2] ?? "";
    }
    return attrs;
  }
  function processHTML(input, knownElements) {
    ...
    while ((match = tagRe.exec(input)) !== null) {
      ...
      if (replacements2.some((r6) => match.index > r6.start && match.index < r6.end)) continue;
    ...
    for (let i7 = replacements2.length - 1; i7 >= 0; i7--) {
      const { start, end, replacement } = replacements2[i7];
  ...
  function readUntilNul() {
    ...
    for (; ; ) {
      const n7 = Javy.IO.readSync(0, buf);
      if (n7 === 0) return chunks.length > 0 ? new TextDecoder().decode(new Uint8Array(chunks)) : null;
